...
export default function Brain() {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      {
        "prompt": "",
        "summary": "The requested changes involve core configuration values that can only be modified through the dedicated configuration interfaces in the navbar. Please use the Company Info or Agent Config options in the navbar to make these changes.",
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
          ...
          <AnimatePresence mode="wait">
            {!showInterface ? (
              ...
              >
                ...
                >
                  Click the brain to start modifying your agent
                </motion.p>
              </motion.div>
            ) : (
              <motion.div
      ...
      >
        <ModalOverlay />
        <ModalContent>
          <ModalHeader>Share Your Agent</ModalHeader>
          <ModalCloseButton />
          <ModalBody pb={6}>
            <Tabs variant="soft-rounded" colorScheme="blue">
              ...
              <TabPanels>
                ...
                <TabPanel>
                  <VStack align="stretch" spacing={4}>
                    <Text fontSize="sm" color="gray.600">
                      Add this code to embed the {selectedMode} agent in your
                      website:
                    </Text>
                    <Box
                      p={4}
